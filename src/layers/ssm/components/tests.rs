...
fn test_linear_projection_eprop_gradients() {
    ...
    crate::eprop::context::EpropContext::init_for_layers(vec![(output_dim, input_dim)]);
    crate::eprop::context::EpropContext::with_traces(|traces| {
    ...
    crate::eprop::context::EpropContext::clear();
}
...
fn test_ssm_activation_config() {
    ...
    assert!(matches!(
        activation.activation.richards_curve.variant,
