//! Shared Residual Connection Component
//!
//! This component provides residual connection functionality that can be used
...
pub struct SharedResidualConnection {
...
impl SharedResidualConnection {
    /// Create a new shared residual connection component
