...
//!
//! ```rust
//! use llm::domain::eprop::context::EpropContext;
//!
...
impl EpropContext {
    ...
    /// ```
    /// use llm::domain::eprop::context::EpropContext;
    /// use llm::domain::eprop::traces::EligibilityTraces;
    /// EpropContext::init_for_layers(vec![(10, 5)]);
    /// let result = EpropContext::with_traces(|traces: &mut Vec<EligibilityTraces>| {
