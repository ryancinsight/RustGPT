...
use crate::domain::eprop::EPropError;
...
impl AdaptiveSurrogate {
    ...
    fn update_performance_metrics(
        ...
        let spike_efficiency = if avg_surrogate > 0.0 {
            crate::domain::richards::RichardsCurve::sigmoid(false).forward_scalar_f32(avg_surrogate)
        } else {
            0.0
        };
...
mod tests {
    ...
    use super::*;
    use crate::domain::eprop::{config::NeuronConfig, neuron::NeuronState};
