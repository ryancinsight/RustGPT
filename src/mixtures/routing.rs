...
fn apply_softmax_selection(gates: &ndarray::ArrayView2<f32>, temperature: f32) -> ndarray::Array2<f32> {
...
pub fn compute_avg_active_components(routing_weights: &ndarray::ArrayView2<f32>) -> f32 {
    ...
    routing_weights.outer_iter()
        ...
        .sum::<f32>() / routing_weights.nrows() as f32
}
...
mod tests {
    ...
    fn test_top_k_selection() {
        let gates = Array2::from_shape_vec((2, 3), vec![
