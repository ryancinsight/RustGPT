...
// - src/model/builder.rs (compiled as `crate::model_builder`)
// - and also available under `crate::model::builder`.
//
// This file is intentionally empty so it cannot diverge.

compile_error!("src/model_builder.rs is legacy; use src/model/builder.rs");
