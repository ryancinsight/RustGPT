...
fn test_cope_gate_computation() {
    ...
    for &val in position_logits.iter() {
        assert!(val.is_finite(), "Position logit should be finite, got {}", val);
    }
}
...
fn test_cope_position_clamping() {
    ...
    for &val in position_logits.iter() {
        assert!(val.is_finite(), "Position logit should be finite after clamping");
    }
}
...
fn test_cope_interpolation() {
    ...
    for &val in position_logits.iter() {
        assert!(val.is_finite(), "Interpolation should produce finite values");
    }
}
...
fn test_cope_max_pos_boundary() {
    ...
    for &val in position_logits.iter() {
        assert!(val.is_finite(), "Values at max_pos boundary should be finite");
    }
}
