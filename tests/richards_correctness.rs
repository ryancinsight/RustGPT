...
mod tests {
    ...
    fn test_forward_matrix_correctness() {
        ...
        assert!((out[[0, 0]] - expected).abs() < 1e-6, "Forward mismatch: got {}, expected {}", out[[0, 0]], expected);
    }
    ...
    fn test_forward_matrix_f32_correctness() {
        ...
        assert!((out[[0, 0]] - expected).abs() < 1e-6, "Forward f32 mismatch: got {}, expected {}", out[[0, 0]], expected);
    }
    ...
    fn test_backward_matrix_correctness() {
        ...
        assert!((dx[[0, 0]] - expected).abs() < 1e-6, "Backward mismatch: got {}, expected {}", dx[[0, 0]], expected);
    }
    ...
    fn test_backward_matrix_f32_correctness() {
        ...
        assert!((dx[[0, 0]] - expected).abs() < 1e-6, "Backward f32 mismatch: got {}, expected {}", dx[[0, 0]], expected);
    }
    ...
    fn test_grad_weights_matrix_correctness() {
        ...
        for i in 0..len {
            assert!((grads[i] - grads_identity[i]).abs() < 1e-6, "Scalar gradient {} mismatch", i);
        }
    }
