use llm::{BeamSearchConfig, BeamSearchState, BeamHypothesis, build_network, ModelConfig, Vocab, LLM};
use ndarray::Array1;
...
fn test_beam_search_state_mark_complete() {
    ...
    state.beams.push(BeamHypothesis::new(vec![1, 2, end_token], -1.0));
...
fn test_beam_search_state_get_best() {
    ...
    assert_eq!(best_hypothesis.normalized_score(), -0.5);
}
